...
#ifndef SRCCHAIN_WALLET_WALLET_H
#define SRCCHAIN_WALLET_WALLET_H
...
public:
     ...
     * on this srcchain node, and set to 0 for transactions that were created
...
#endif // SRCCHAIN_WALLET_WALLET_H
