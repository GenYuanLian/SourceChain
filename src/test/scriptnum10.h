...
#ifndef SRCCHAIN_TEST_SCRIPTNUM10_H
#define SRCCHAIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Srcchain Core 0.10.0, for cross-comparison.
 */
public:
