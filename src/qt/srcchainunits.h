...
#ifndef SRCCHAIN_QT_SRCCHAINUNITS_H
#define SRCCHAIN_QT_SRCCHAINUNITS_H
...
/** Srcchain unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SrcchainUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SrcchainUnits(QObject *parent);

    /** Srcchain units.
      @note Source: https://en.srcchain.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BSTK,
...
typedef SrcchainUnits::Unit SrcchainUnit;

#endif // SRCCHAIN_QT_SRCCHAINUNITS_H
