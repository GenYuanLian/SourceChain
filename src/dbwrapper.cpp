...
class CSrcchainLevelDBLogger : public leveldb::Logger {
public:
    ...
    virtual void Logv(const char * format, va_list ap) override {
            ...
            for (int iter = 0; iter < 2; iter++) {
                ...
                if (p < limit) {
                    ...
                    // Do not use vsnprintf elsewhere in srcchain source code, see above.
