...
from test_framework.test_framework import SrcchainTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (SrcchainTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that srcchain has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("srcchaind has not been built with zmq enabled.")
