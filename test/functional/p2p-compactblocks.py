...
# TestNode: A peer we use to send messages to srcchaind, and store responses.
...
class CompactBlocksTest(SrcchainTestFramework):
    ...
    # This test actually causes srcchaind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that srcchaind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for srcchaind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # srcchaind will not send blocktxn responses for blocks whose height is
