...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the SrcchainTestFramework
    pass

class ExampleTest(SrcchainTestFramework):
    # Each functional test is a subclass of the SrcchainTestFramework class.
    ...
    def custom_method(self):
        ...
        SrcchainTestFramework class so other tests can use it."""
