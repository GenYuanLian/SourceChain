...
class BIP66Test(SrcchainTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # srcchaind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and srcchaind produces more specific reject
            # reasons.
