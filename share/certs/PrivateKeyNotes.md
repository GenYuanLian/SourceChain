...
unlocked to sign the Srcchain-Qt.app bundle.
...
allowing somebody to distribute a Srcchain-Qt.app or srcchain-qt-setup.exe with a valid
...
that the srcchain-qt.exe file inside the installer had not been tampered with.
