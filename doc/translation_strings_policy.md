...
This document provides guidelines for internationalization of the Srcchain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `srcchain_en.ts` remains unchanged.
